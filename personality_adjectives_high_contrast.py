...
class PistolGame(object):
    ...
    def __init__(self):
        ...
        self.object_lower = (96, 94, 225)# HSV color range for object to be tracked
        self.object_upper = (115, 255, 255)
        ...
        self.game_display.fill(PistolGame.BLACK)
        pygame.display.update()

    def text_objects(self, text, font):
        text_surface = font.render(text, True, PistolGame.WHITE)
    ...
    def run(self):
        ...
        while not self.finished:
            ...
            if rect0.collidepoint(int_x, int_y) or rect1.collidepoint(int_x, int_y) or rect2.collidepoint(int_x, int_y) or rect3.collidepoint(int_x, int_y):
                ...
                pygame.draw.circle(self.game_display, PistolGame.WHITE,(int_x, int_y), 10)
