...
<<<<<<< HEAD
        self.verbs = ['Accept', 'Care', 'Could', 'Enjoy', 'Happen', 'Lead', 'Open', 'Reduce', 'Settle', 'Teach', 'Carry', 'Count', 'Examine', 'Hate', 'Learn', 'Order', 'Refer', 'Shake', 'Tell', 'Catch', 'Cover', 'Exist', 'Have', 'Leave', 'Ought', 'Reflect', 'Shall', 'Tend', 'Cause', 'Create', 'Expect', 'Head', 'Lend', 'Own', 'Refuse', 'Share', 'Test', 'Change', 'Cross', 'Experience', 'Hear', 'Let', 'Pass', 'Regard', 'Shoot', 'Thank', 'Charge', 'Cry', 'Explain', 'Help', 'Lie', 'Pay', 'Relate', 'Should', 'Think', 'Check', 'Cut', 'Express', 'Hide', 'Like', 'Perform', 'Release', 'Shout', 'Throw', 'Choose', 'Damage', 'Extend', 'Hit', 'Limit', 'Pick', 'Remain', 'Show', 'Touch', 'Claim', 'Dance', 'Face', 'Hold', 'Link', 'Place', 'Remember', 'Shut', 'Train', 'Clean', 'Deal', 'Fail', 'Hope', 'Listen', 'Plan', 'Remove', 'Sing', 'Travel', 'Clear', 'Decide', 'Fall', 'Hurt', 'Live', 'Play', 'Repeat', 'Sit', 'Treat', 'Climb', 'Deliver', 'Fasten', 'Identify', 'Look', 'Point', 'Replace', 'Sleep', 'Try', 'Close', 'Demand', 'Feed', 'Imagine', 'Lose', 'Prefer', 'Reply', 'Smile', 'Turn', 'Collect', 'Deny', 'Feel', 'Improve', 'Love', 'Prepare', 'Report', 'Sort', 'Understand', 'Come', 'Depend', 'Fight', 'Include', 'Make', 'Present', 'Represent', 'Sound', 'Use', 'Commit', 'Describe', 'Fill', 'Increase', 'Manage', 'Press', 'Require', 'Speak', 'Compare', 'Design', 'Find', 'Indicate', 'Mark', 'Prevent', 'Rest', 'Stand', 'Visit', 'Complain', 'Destroy', 'Finish', 'Influence', 'Matter', 'Produce', 'Result', 'Start', 'Vote', 'Complete', 'Develop', 'Fit', 'Inform', 'May', 'Promise', 'Return', 'State', 'Wait', 'Concern', 'Die', 'Fly', 'Intend', 'Mean', 'Protect', 'Reveal', 'Stay', 'Walk', 'Confirm', 'Disappear', 'Fold', 'Introduce', 'Measure', 'Prove', 'Ring', 'Stick', 'Want', 'Connect', 'Discover', 'Follow', 'Invite', 'Meet', 'Provide', 'Rise', 'Stop', 'Warn', 'Consider', 'Discuss', 'Force', 'Involve', 'Mention', 'Publish', 'Roll', 'Study', 'Wash', 'Consist', 'Divide', 'Forget', 'Join', 'Might', 'Pull', 'Run', 'Succeed', 'Watch', 'Contact', 'Do', 'Forgive', 'Jump', 'Mind', 'Push', 'Save', 'Suffer', 'Wear', 'Contain', 'Draw', 'Form', 'Keep', 'Miss', 'Put', 'Say', 'Suggest', 'Will', 'Continue', 'Dress', 'Found', 'Kick', 'Move', 'Raise', 'See', 'Suit', 'Win', 'Contribute', 'Drink', 'Gain', 'Kill', 'Must', 'Reach', 'Seem', 'Supply', 'Wish', 'Control', 'Drive', 'Get', 'Knock', 'Need', 'Read', 'Sell', 'Support', 'Wonder', 'Cook', 'Drop', 'Give', 'Know', 'Notice', 'Realize', 'Send', 'Suppose', 'Work', 'Copy', 'Eat', 'Go', 'Last', 'Obtain', 'Receive', 'Separate', 'Survive', 'Worry', 'Correct', 'Enable', 'Grow', 'Laugh', 'Occur', 'Recognize', 'Serve', 'Take', 'Would', 'Cost', 'Encourage', 'Handle', 'Lay', 'Offer', 'Record', 'Set', 'Talk', 'Write']
=======
        self.verbs = ['Accept', 'Care', 'Could', 'Enjoy', 'Happen', 'Lead', 'Open', 'Reduce', 'Settle', 'Teach account', 'Carry', 'Count', 'Examine', 'Hate', 'Learn', 'Order', 'Refer', 'Shake', 'Tell achieve', 'Catch', 'Cover', 'Exist', 'Have', 'Leave', 'Ought', 'Reflect', 'Shall', 'Tend', 'Cause', 'Create', 'Expect', 'Head', 'Lend', 'Own', 'Refuse', 'Share', 'Test add', 'Change', 'Cross', 'Experience', 'Hear', 'Let', 'Pass', 'Regard', 'Shoot', 'Thank', 'Charge', 'Cry', 'Explain', 'Help', 'Lie', 'Pay', 'Relate', 'Should', 'Think affect', 'Check', 'Cut', 'Express', 'Hide', 'Like', 'Perform', 'Release', 'Shout', 'Throw afford', 'Choose', 'Damage', 'Extend', 'Hit', 'Limit', 'Pick', 'Remain', 'Show', 'Touch agree', 'Claim', 'Dance', 'Face', 'Hold', 'Link', 'Place', 'Remember', 'Shut', 'Train', 'Clean', 'Deal', 'Fail', 'Hope', 'Listen', 'Plan', 'Remove', 'Sing', 'Travel', 'Clear', 'Decide', 'Fall', 'Hurt', 'Live', 'Play', 'Repeat', 'Sit', 'Treat', 'Climb', 'Deliver', 'Fasten', 'Identify', 'Look', 'Point', 'Replace', 'Sleep', 'Try appear', 'Close', 'Demand', 'Feed', 'Imagine', 'Lose', 'Prefer', 'Reply', 'Smile', 'Turn apply', 'Collect', 'Deny', 'Feel', 'Improve', 'Love', 'Prepare', 'Report', 'Sort', 'Understand argue', 'Come', 'Depend', 'Fight', 'Include', 'Make', 'Present', 'Represent', 'Sound', 'Arrange', 'Commit', 'Describe', 'Fill', 'Increase', 'Manage', 'Press', 'Require', 'Speak', 'Compare', 'Design', 'Find', 'Indicate', 'Mark', 'Prevent', 'Rest', 'Stand', 'Visit', 'Complain', 'Destroy', 'Finish', 'Influence', 'Matter', 'Produce', 'Result', 'Start', 'Vote', 'Complete', 'Develop', 'Fit', 'Inform', 'May', 'Promise', 'Return', 'State', 'Wait avoid', 'Concern', 'Die', 'Fly', 'Intend', 'Mean', 'Protect', 'Reveal', 'Stay', 'Walk base', 'Confirm', 'Disappear', 'Fold', 'Introduce', 'Measure', 'Prove', 'Ring', 'Stick', 'Want be', 'Connect', 'Discover', 'Follow', 'Invite', 'Meet', 'Provide', 'Rise', 'Stop', 'Warn', 'Consider', 'Discuss', 'Force', 'Involve', 'Mention', 'Publish', 'Roll', 'Study', 'Wash', 'Consist', 'Divide', 'Forget', 'Join', 'Might', 'Pull', 'Run', 'Succeed', 'Watch', 'Contact', 'Do', 'Forgive', 'Jump', 'Mind', 'Push', 'Save', 'Suffer', 'Wear', 'Contain', 'Draw', 'Form', 'Keep', 'Miss', 'Put', 'Say', 'Suggest', 'Will', 'Continue', 'Dress', 'Found', 'Kick', 'Move', 'Raise', 'See', 'Suit', 'Win', 'Contribute', 'Drink', 'Gain', 'Kill', 'Must', 'Reach', 'Seem', 'Supply', 'Wish', 'Control', 'Drive', 'Get', 'Knock', 'Need', 'Read', 'Sell', 'Support', 'Wonder', 'Cook', 'Drop', 'Give', 'Know', 'Notice', 'Realize', 'Send', 'Suppose', 'Work buy', 'Copy', 'Eat', 'Go', 'Last', 'Obtain', 'Receive', 'Separate', 'Survive', 'Worry call', 'Correct', 'Enable', 'Grow', 'Laugh', 'Occur', 'Recognize', 'Serve', 'Take', 'Would', 'Cost', 'Encourage', 'Handle', 'Lay', 'Offer', 'Record', 'Set', 'Talk', 'Write']
>>>>>>> ec0d7474640efcdf52d919b25089a9f01d450a8b
        
        self.adjectives = ['Ambitious', 'Single-minded', 'Determined', 'Reliable', 'Honest', 'Stable', 'Independent', 'Confident', 'Calm ', 'Loyal', 'Sympathetic', 'Sociable', 'Creative', 'Energetic', 'Enthusiastic', 'Unambitious', 'Attractive', 'Unattractive', 'Incompetent', 'Competent', 'Dependent', 'Experienced', 'Inexperienced', 'Formal', 'Informal', 'Popular ', 'Unpopular', 'Reasonable', 'Unreasonable', 'Unreliable', 'Sensitive', 'Insensitive', 'Unsociable', 'Tolerant', 'Intolerant']
