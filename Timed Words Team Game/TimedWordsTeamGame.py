...
class TimedWordsTeamGame(object):
    ...
    def refresh_display(self):
        ...
        team3Label = self.team_font.render(self.team_3_name, True, TimedWordsTeamGame.BLACK)
        team4Label = self.team_font.render(self.team_4_name, True, TimedWordsTeamGame.BLACK)
        team5Label = self.team_font.render(self.team_5_name, True, TimedWordsTeamGame.BLACK)
        team6Label = self.team_font.render(self.team_6_name, True, TimedWordsTeamGame.BLACK)
        ...
        pygame.draw.rect(self.DISPLAYSURF, TimedWordsTeamGame.RED, team3Rect)
        pygame.draw.rect(self.DISPLAYSURF, TimedWordsTeamGame.RED, team4Rect)
        pygame.draw.rect(self.DISPLAYSURF, TimedWordsTeamGame.RED, team5Rect)
        pygame.draw.rect(self.DISPLAYSURF, TimedWordsTeamGame.RED, team6Rect)
