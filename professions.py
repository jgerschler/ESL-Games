...
##        self.object_upper = (108, 255, 255)
        ...
        self.professions = [
				...
				{'electrician':'electricista','gardener':'jardinero','mechanic':'mecanico','bus driver':'chofer de autobus',
				...
				'teacher':'maestro','':'','':''}
				['electrician', 'gardener', 'mechanic', 'bus driver', 'hairdresser', 
				'construction worker', 'mason', 'pump attendant',
				'garbage man', 'mailman', 'architect',
				'cook', 'photographer', 'butcher', 'waiter', 'waitress', 'dentist', 'baker',
				'cleaning lady', 'salesman', 'actress', 'artist', 'doctor', 'engineer',
				'fireman', 'housewife', 'nurse', 'pilot', 'policeman', 'cashier', 'painter',
				'secretary', 'singer', 'veterinarian', 'soldier', 'carpenter', 'businessman', 'detective', 'plumber', 'surgeon', 'writer', 'farmer',
				'spy', 'lawyer', 'judge', 'journalist', 'teacher', 'delivery boy']
