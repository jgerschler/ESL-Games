...
##        self.object_upper = (108, 255, 255)
    ...
    def Word(self):
        ...
        self.x = random.randint(math.ceil(self.left_border + self.rect.width),
                                math.ceil(self.right_border - self.rect.width))
        self.y = random.randint(math.ceil(self.top_border + self.rect.height),
                                math.ceil(self.bottom_border - self.rect.height))
        self.speedx = 0.2*(random.random()+0.01)
        self.speedy = 0.2*(random.random()+0.01)
        self.shrink_level = 1
    ...
    def run(self):
        ...
        while not self.finished:
            ...
            for Word in self.Words:
                ...
                game_display.blit(Word.rendered_word, Word.rect)
